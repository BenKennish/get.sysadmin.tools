" Ben Kennish's .vimrc file
" Latest version: https://www.bennish.net/.vimrc
"
" Based on /usr/share/vim/vim72/vimrc_example.vim 
...
" Store backup files somewhere tidier, not current directory
set backupdir=~/.vim/backup/,/var/tmp/,/tmp/,.

" For syntax highlighting, treat .html files as if they are PHP
augroup filetype
   autocmd BufNewFile,BufRead *.html set filetype=php
augroup END

" allow to determine file type via a comment in the file
" set modeline
